...
const ProfileScreen = () => {
    ...
    const ProfileOption: React.FC<ProfileOptionProps> = ({ icon, text, routerUrl }) => (
        <TouchableOpacity style={styles.optionContainer} onPress={() => router.push(routerUrl)}>
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.orderCard}>
                ...
                <View style={styles.orderContent}>
                    <Image
                        source={{ uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-uTZEHO2xIsySDcVVyi5YxF3lKkd1igvt_1Ix8Sm5q6d6Spoj6eXhTn6P1itH_U_VPGY&usqp=CAU" }}
            ...
            <View style={styles.section}>
                <ProfileOption icon="user" text="Personal Data" routerUrl="personal-data" />
            ...
            {/* Support Options */}
            <View style={styles.section}>
                <ProfileOption icon="help-circle" text="Help Center" routerUrl="help-center" />
